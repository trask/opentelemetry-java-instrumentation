...
public abstract class DbInfo {
  ...
  // Bridge getters used by JdbcConnectionUrlParser — to be removed in 3.0
  @Nullable
  ...
  public abstract static class Builder {
    ...
    // Bridge methods used by JdbcConnectionUrlParser — to be removed in 3.0
    ...
    public Builder name(String name) {
      return dbName(name).dbNamespace(name);
    }
