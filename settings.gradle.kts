...
include(":instrumentation:jdbc-datasource:bootstrap")
include(":instrumentation:jdbc-datasource:javaagent")
include(":instrumentation:jdbc-datasource:library")
include(":instrumentation:jdbc-datasource:testing")
